...
${seniorityLevel === 'operational' ? `      * PUESTO OPERATIVO / RETAIL / SUPERMERCADOS / TIENDA:
        • RESUMEN PROFESIONAL (3-4 frases): Adapta la presentación para ser ALTAMENTE ATRACTIVO para un entorno físico de retail. Elimina por completo referencias a "Transformación digital", "IA", "Optimización de experiencia del cliente" o perfiles corporativos de oficina. Enfócate 100% en habilidades de tienda física: gestión de turnos, apertura/cierre, control de stock, mermas, inventarios, atención al cliente en sala de ventas y liderazgo de equipo de piso.
        • EXPERIENCIA LABORAL: Adapta CADA UNA de las experiencias al entorno operativo de tienda. 
          - Para el rol de "Gestor de Negocio Familiar": DEBES usar frases como "Gestión operativa integral de punto de venta y atención al cliente. Responsable de la apertura y cierre del establecimiento, control de inventario diario, recepción de mercancías, reaprovisionamiento y arqueo de caja."
          - Para roles de "Supervisor en Telefónica" o "Supervisor Regional": DEBES usar frases como "Dirección estratégica y operativa de tiendas físicas de atención y venta. Supervisión directa de la puesta a punto de los locales, control de horarios del personal, optimización de flujos de clientes y auditoría de estándares de exposición comercial."
        • DOMINIOS: MÍNIMO 4 bloques de competencias. OMITE CUALQUIER MENCIÓN a "IA", "Transformación" o "Productividad de IA". Enfócate en Liderazgo, Atención al Cliente, Gestión de Operaciones y Ventas.`
: seniorityLevel === 'middle' ? `      * PUESTO MANDO MEDIO / SUPERVISOR:
        • RESUMEN EJECUTIVO (3-4 frases): Perfil muy atractivo y elegible. Equilibra liderazgo y gestión de equipo con un enfoque práctico y operativo. EVITA sonar sobrecualificado o excesivamente directivo. Elimina datos excesivamente técnicos si no los pide la oferta. El candidato debe presentarse como Supervisor o Gestor.
        • EXPERIENCIA LABORAL: OBLIGATORIO EXACTAMENTE 3 VIÑETAS POR CARGO. Enfoca los logros en la mejora de KPIs de tienda, apoyo al equipo y calidad de servicio. Suprime jerga tecnológica compleja.
        • DOMINIOS: MÍNIMO 4 bloques de competencias, priorizando gestión de equipos y operaciones.`
...
3. REGLAS GENERALES Y CANTIDADES ESTRICTAS (ANTI-ALUCINACIONES):
   ...
   - CERTIFICACIONES: Selecciona OBLIGATORIAMENTE EXACTAMENTE 4 certificaciones del listado real del CV base.
   - Resumen Profesional (summary): Debe empezar obligatoriamente con el título PROFESIONAL REAL DEL CANDIDATO (Ej. "Supervisor de Operaciones", "Gestor de Negocio", "Líder de Equipo" o "Ejecutivo"). ESTRICTAMENTE PROHIBIDO iniciar el resumen llamando al candidato "Encargado de Tienda", "Dependiente", "Cajero" o cualquier título inferior a su experiencia real, incluso si aplica a ese puesto. El candidato es un Supervisor/Gestor postulando al rol, no pierdas su jerarquía en la presentación. PROHIBIDO inventar conocimientos falsos. REGLA SAGRADA: Queda ESTRICTAMENTE PROHIBIDO mencionar "telecomunicaciones" o sectores ajenos a menos que la oferta sea expresamente de telecomunicaciones. Escribe un resumen corto y contundente de OBLIGATORIAMENTE ENTRE 40 Y 60 PALABRAS (2 a 3 frases fluidas y persuasivas directamente enfocadas al rol). ESTRICTAMENTE PROHIBIDO repetir las funciones o tareas de la experiencia laboral en el resumen; el resumen debe enfocarse en tu propuesta de valor, actitud y habilidades.
   ...
   - Experiencia (experience): ¡ATENCIÓN! EL CV BASE TIENE EXACTAMENTE 8 EXPERIENCIAS LABORALES. ES ESTRICTAMENTE OBLIGATORIO PROCESAR Y DEVOLVER UN ARRAY DE EXACTAMENTE 8 ELEMENTOS. PROHIBIDO OMITIR EXPERIENCIAS, EN ESPECIAL "Supervisor Regional". SI OMITES ALGUNA, EL JSON SERÁ RECHAZADO. REGLA CRÍTICA: Cada cargo DEBE tener EXACTAMENTE 3 viñetas (descriptions). Las viñetas deben ser ORACIONES COMPLETAS Y DETALLADAS (MÍNIMO 15 PALABRAS POR VIÑETA), explicando la acción y el resultado. QUEDA ESTRICTAMENTE PROHIBIDO poner solo 2, 3 o 7 palabras como "Atención al cliente". ESTRICTAMENTE PROHIBIDO REPETIR VIÑETAS.
