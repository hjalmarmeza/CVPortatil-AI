...
${seniorityLevel === 'operational' ? `      * PUESTO OPERATIVO / TIENDA / ATENCIÓN AL CLIENTE:
        • RESUMEN PROFESIONAL (3-4 frases): Adapta la presentación para ser ALTAMENTE ATRACTIVO para el rol, pero SIN SONAR SOBRECUALIFICADO. Presenta al candidato como un perfil hands-on, dinámico, enfocado en trabajo en equipo, trato al cliente y resolución de problemas. Elimina por completo jerga corporativa compleja, menciones a "transformación digital" o datos técnicos de software. PROHIBIDO iniciar diciendo "Dependiente de Tienda", "Cajero" o similares. Mantén la dignidad de su experiencia (ej. "Gestor especializado en...", "Profesional con sólida experiencia en..."). 
        • EXPERIENCIA LABORAL: DEBE REDACTARSE EN PRIMERA PERSONA DEL SINGULAR ACTIVA. OBLIGATORIO EXACTAMENTE 3 VIÑETAS POR CARGO (mínimo 15 palabras). Traduce cualquier logro ejecutivo a un lenguaje operativo, de piso y de apoyo al cliente/equipo. ELIMINA nombres de software técnico (SAP, Amdocs, Qmatic) y jerga directiva.
        • DOMINIOS: MÍNIMO 4 bloques de competencias ESTRICTAMENTE EXTRAÍDOS del CV base, seleccionando SOLO los más operativos (ej. atención, ventas, resolución) y omitiendo los técnicos.`
