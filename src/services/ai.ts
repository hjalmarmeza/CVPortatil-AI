...
${seniorityLevel === 'operational' ? `      * PUESTO OPERATIVO / TRABAJO DE CAMPO / ATENCIÓN FÍSICA:
        • RESUMEN PROFESIONAL (3-4 frases): Adapta la presentación para ser ALTAMENTE ATRACTIVO para un entorno operativo o físico. Elimina por completo referencias a "Transformación digital", "IA", "Optimización de experiencia" o perfiles corporativos de oficina. Enfócate 100% en habilidades de primera línea: liderazgo de equipos en terreno, gestión de incidencias, control de inventarios/stock, apertura/cierre de locales, o atención directa al cliente según lo requiera la oferta.
        • EXPERIENCIA LABORAL: Adapta CADA UNA de las experiencias al entorno operativo requerido. 
          - Traduce cualquier cargo de "Gestor" o "Director" a sus funciones más tangibles (ej. "Gestión operativa integral del punto de venta/servicio, responsable de la rentabilidad diaria y control de inventarios").
          - Traduce roles de "Supervisor" a su impacto en el terreno (ej. "Supervisión directa de la puesta a punto de locales/operaciones, control de horarios del personal y auditoría de estándares de calidad").
        • DOMINIOS: MÍNIMO 4 bloques de competencias. OMITE CUALQUIER MENCIÓN a "IA", "Transformación" o jerga directiva. Enfócate en Liderazgo, Atención al Cliente, Gestión de Operaciones y Resolución de Conflictos.`
: seniorityLevel === 'middle' ? `      * PUESTO MANDO MEDIO / SUPERVISOR:
        ...
        • EXPERIENCIA LABORAL: OBLIGATORIO EXACTAMENTE 3 VIÑETAS POR CARGO. Enfoca los logros en la mejora de KPIs, apoyo al equipo y calidad de servicio. Suprime jerga tecnológica compleja.
