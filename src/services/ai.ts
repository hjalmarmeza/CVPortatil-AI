...
3. REGLAS GENERALES Y CANTIDADES ESTRICTAS (ANTI-ALUCINACIONES):
   ...
   - Resumen Profesional (summary): Debe empezar con tu título profesional adaptado al puesto objetivo. Adapta explícitamente el enfoque a la industria de la oferta. REGLA ESTRICTA: PROHIBIDO incluir cifras, números, porcentajes, métricas o cantidades de personal. Escribe un resumen de OBLIGATORIAMENTE ENTRE 100 Y 120 PALABRAS (4 a 5 frases completas, densas, directivas y persuasivas). PROHIBIDO escribir resúmenes cortos de 1 o 2 líneas. NO uses jerga corporativa excesiva ni suenes robótico.
